...
export const places: Place[] = [
  ...
  { id: "shibuya", name: "Shibuya", district: "Central Hub", line: "Commuter Pass", unlock: "Story event on 4/11", unlockAt: "4/11", unlockKind: "story", route: ["Press R1 and choose Shibuya", "Select Central Street, Underground Mall, Station Square, or Underground Walkway", "The commuter pass makes this route free"], spots: ["Central Street", "Underground Mall", "Station Square", "Airsoft Shop", "Arcade"], keywords: ["shibuya", "central street", "underground mall", "station square", "underground walkway", "airsoft", "flower shop", "beef bowl", "movie", "arcade"], x: 35, y: 53, tone: "red" },
  ...
  { id: "nakano", name: "Nakano", district: "Shopping District", line: "Invitation Route", unlock: "Futaba invitation on 10/8", unlockAt: "10/8", unlockKind: "guide", route: ["Accept Futaba's 10/8 invitation", "Nakano appears on the map", "Enter the shopping mall"], spots: ["Shopping Mall"], keywords: ["nakano", "shopping mall"], x: 31, y: 18, tone: "red" },
  { id: "maihama", name: "Maihama", district: "Theme Park District", line: "Story / Book Route", unlock: "Story visit on 10/11 or Theme Park Escort", unlockAt: "10/11", unlockKind: "story", route: ["Complete the 10/11 story visit or read Theme Park Escort", "Choose Maihama", "Enter Destinyland with an eligible Confidant"], spots: ["Destinyland"], keywords: ["maihama", "destinyland", "theme park"], x: 89, y: 73, tone: "red" },
